...
public class BucketsOfSlime extends DailyInfobox {
    ...
    public BucketsOfSlime(final Provider provider) {
        super(TicTac7xDailyTasksConfig.buckets_of_slime, ItemId.BUCKET_OF_SLIME, provider);
    }
    ...
    private int getRemainingBucketsOfSlimeAmount() {
        ...
        return buckets_of_slime - provider.client.getVarbitValue(VarbitId.MORYTANIA_SLIME_COLLECTED);
    }
}
