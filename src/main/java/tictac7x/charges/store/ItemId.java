...
public class ItemId {
    ...
    // Blood moon.
    public static int BLOOD_MOON_HELM = ItemID.BLOOD_MOON_HELM;
    public static int BLOOD_MOON_HELM_DEGRADED = ItemID.BLOOD_MOON_HELM_DEGRADED;
    public static int BLOOD_MOON_HELM_BROKEN = ItemID.BLOOD_MOON_HELM_BROKEN;
    public static int BLOOD_MOON_CHESTPLATE = ItemID.BLOOD_MOON_CHESTPLATE;
    public static int BLOOD_MOON_CHESTPLATE_DEGRADED = ItemID.BLOOD_MOON_CHESTPLATE_DEGRADED;
    public static int BLOOD_MOON_CHESTPLATE_BROKEN = ItemID.BLOOD_MOON_CHESTPLATE_BROKEN;
    public static int BLOOD_MOON_TASSETS = ItemID.BLOOD_MOON_TASSETS;
    public static int BLOOD_MOON_TASSETS_DEGRADED = ItemID.BLOOD_MOON_TASSETS_DEGRADED;
    public static int BLOOD_MOON_TASSETS_BROKEN = ItemID.BLOOD_MOON_TASSETS_BROKEN;

    // Blue moon.
    public static int BLUE_MOON_HELM = ItemID.FROST_MOON_HELM;
    public static int BLUE_MOON_HELM_DEGRADED = ItemID.FROST_MOON_HELM_DEGRADED;
    public static int BLUE_MOON_HELM_BROKEN = ItemID.FROST_MOON_HELM_BROKEN;
    public static int BLUE_MOON_CHESTPLATE = ItemID.FROST_MOON_CHESTPLATE;
    public static int BLUE_MOON_CHESTPLATE_DEGRADED = ItemID.FROST_MOON_CHESTPLATE_DEGRADED;
    public static int BLUE_MOON_CHESTPLATE_BROKEN = ItemID.FROST_MOON_CHESTPLATE_BROKEN;
    public static int BLUE_MOON_TASSETS = ItemID.FROST_MOON_TASSETS;
    public static int BLUE_MOON_TASSETS_DEGRADED = ItemID.FROST_MOON_TASSETS_DEGRADED;
    public static int BLUE_MOON_TASSETS_BROKEN = ItemID.FROST_MOON_TASSETS_BROKEN;

    // Eclipse moon.
    public static int ECLIPSE_MOON_HELM = ItemID.ECLIPSE_MOON_HELM;
    public static int ECLIPSE_MOON_HELM_DEGRADED = ItemID.ECLIPSE_MOON_HELM_DEGRADED;
    public static int ECLIPSE_MOON_HELM_BROKEN = ItemID.ECLIPSE_MOON_HELM_BROKEN;
    public static int ECLIPSE_MOON_CHESTPLATE = ItemID.ECLIPSE_MOON_CHESTPLATE;
    public static int ECLIPSE_MOON_CHESTPLATE_DEGRADED = ItemID.ECLIPSE_MOON_CHESTPLATE_DEGRADED;
    public static int ECLIPSE_MOON_CHESTPLATE_BROKEN = ItemID.ECLIPSE_MOON_CHESTPLATE_BROKEN;
    public static int ECLIPSE_MOON_TASSETS = ItemID.ECLIPSE_MOON_TASSETS;
    public static int ECLIPSE_MOON_TASSETS_DEGRADED = ItemID.ECLIPSE_MOON_TASSETS_DEGRADED;
    public static int ECLIPSE_MOON_TASSETS_BROKEN = ItemID.ECLIPSE_MOON_TASSETS_BROKEN;
