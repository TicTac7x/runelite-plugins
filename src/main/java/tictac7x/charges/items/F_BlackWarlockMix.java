...
public class F_BlackWarlockMix extends ChargedItem {
    public F_BlackWarlockMix(
        ...
        super(ChargesImprovedConfig.black_warlock_mix, ItemID.BLACK_WARLOCK_MIX_1, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
