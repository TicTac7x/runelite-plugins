...
public class W_CrystalBow extends ChargedItem {
    public W_CrystalBow(
        ...
        super(ChargesImprovedConfig.crystal_bow, ItemID.CRYSTAL_BOW, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
