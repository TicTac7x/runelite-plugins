...
public class J_DesertAmulet extends ChargedItem {
    public J_DesertAmulet(
        ...
        super(ChargesImprovedConfig.desert_amulet, ItemID.DESERT_AMULET_2, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
