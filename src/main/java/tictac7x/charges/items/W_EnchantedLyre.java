...
public class W_EnchantedLyre extends ChargedItem {
    public W_EnchantedLyre(
        ...
        super(ChargesImprovedConfig.enchanted_lyre, ItemID.ENCHANTED_LYRE, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
