...
public class EclipseMoonChestplate extends ChargedItem {
    public EclipseMoonChestplate(
        ...
        super(TicTac7xChargesImprovedConfig.moons_gear, ItemID.ECLIPSE_MOON_CHESTPLATE_29031, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
        ...
        this.triggers = new TriggerBase[]{
            ...
            // In combat.
            new OnCombat(90).decreaseCharges(1),
        };
    }
}