...
public class U_StrangeOldLockpick extends ChargedItem {
    public U_StrangeOldLockpick(
        ...
        super(ChargesImprovedConfig.strange_old_lockpick, ItemID.STRANGE_OLD_LOCKPICK, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
