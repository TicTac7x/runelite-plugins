...
public class W_WesternBanner extends ChargedItem {
    public W_WesternBanner(
        ...
        super(ChargesImprovedConfig.western_banner, ItemID.WESTERN_BANNER_3, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
