...
public class U_GricollersCan extends ChargedItem {
    public U_GricollersCan(
        ...
        super(ChargesImprovedConfig.gricollers_can, ItemID.GRICOLLERS_CAN, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
