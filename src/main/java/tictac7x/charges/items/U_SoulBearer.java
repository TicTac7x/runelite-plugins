...
public class U_SoulBearer extends ChargedItem {
    public U_SoulBearer(
        ...
        super(TicTac7xChargesImprovedConfig.soul_bearer, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
