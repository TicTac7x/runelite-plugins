...
public class U_SoulBearer extends ChargedItem {
    public U_SoulBearer(
        ...
        super(ChargesImprovedConfig.soul_bearer, ItemID.SOUL_BEARER, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
