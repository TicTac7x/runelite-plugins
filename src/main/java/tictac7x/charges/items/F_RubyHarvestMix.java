...
public class F_RubyHarvestMix extends ChargedItem {
    public F_RubyHarvestMix(
        ...
        super(TicTac7xChargesImprovedConfig.ruby_harvest_mix, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
