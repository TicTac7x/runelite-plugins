...
public class U_SilklinedHerbSack extends ChargedItemWithStorageEmptyable {
    public U_SilklinedHerbSack(final Provider provider) {
        super(TicTac7xChargesImprovedConfig.silklined_herb_sack, ItemId.SILKLINED_HERB_SACK, provider);

        this.items = new TriggerItem[]{
            new TriggerItem(ItemId.SILKLINED_HERB_SACK),
            new TriggerItem(ItemId.SILKLINED_HERB_SACK_OPEN),
        };

        storage = storage.setMaximumIndividualQuantity(100).storableItems(
        ...
        this.triggers.addAll(List.of(
            ...
            // Pick guam leaf.
            new OnXpDrop(Skill.FARMING).requiredItem(ItemId.SILKLINED_HERB_SACK_OPEN).onMenuOption("Pick").onMenuTarget("Herbs",
                "Guam herbs"
            ).onMenuImpostor(
                26828,
                39816
            ...
            // Pick lantadyme.
            new OnXpDrop(Skill.FARMING).requiredItem(ItemId.SILKLINED_HERB_SACK_OPEN).onMenuOption("Pick").onMenuTarget("Herbs", "Lantadyme herbs").onMenuImpostor(39796, 39866).addToStorage(ItemId.GRIMY_LANTADYME),
            new OnMenuEntryAdded().isReplaceImpostorId(
