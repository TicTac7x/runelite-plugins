...
public class J_Camulet extends ChargedItem {
    public J_Camulet(
        ...
        super(ChargesImprovedConfig.camulet, ItemID.CAMULET, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
