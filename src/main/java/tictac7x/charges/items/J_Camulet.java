...
public class J_Camulet extends ChargedItem {
    public J_Camulet(
        ...
        super(TicTac7xChargesImprovedConfig.camulet, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
