...
public class S_DragonfireShield extends ChargedItem {
    public S_DragonfireShield(
        ...
        super(ChargesImprovedConfig.dragonfire_shield, ItemID.DRAGONFIRE_SHIELD, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
