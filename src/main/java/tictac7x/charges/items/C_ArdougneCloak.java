...
public class C_ArdougneCloak extends ChargedItem {
    public C_ArdougneCloak(
        ...
        super(ChargesImprovedConfig.ardougne_cloak, ItemID.ARDOUGNE_CLOAK_1, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
