...
public class W_WarpedSceptre extends ChargedItem {
    public W_WarpedSceptre(
        ...
        super(ChargesImprovedConfig.warped_sceptre, ItemID.WARPED_SCEPTRE, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
