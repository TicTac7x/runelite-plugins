...
public class S_FaladorShield extends ChargedItem {
    public S_FaladorShield(
        ...
        super(ChargesImprovedConfig.falador_shield, ItemID.FALADOR_SHIELD_1, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
