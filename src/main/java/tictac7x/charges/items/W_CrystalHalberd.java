...
public class W_CrystalHalberd extends ChargedItem {
    public W_CrystalHalberd(
        ...
        super(ChargesImprovedConfig.crystal_halberd, ItemID.CRYSTAL_HALBERD, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
