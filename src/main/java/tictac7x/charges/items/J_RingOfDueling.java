...
public class J_RingOfDueling extends ChargedItem {
    public J_RingOfDueling(
        ...
        super(ChargesImprovedConfig.ring_of_dueling, ItemID.RING_OF_DUELING1, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
