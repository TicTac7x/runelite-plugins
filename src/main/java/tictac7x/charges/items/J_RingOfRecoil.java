...
public class J_RingOfRecoil extends ChargedItem {
    public J_RingOfRecoil(
        ...
        super(ChargesImprovedConfig.ring_of_recoil, ItemID.RING_OF_RECOIL, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
