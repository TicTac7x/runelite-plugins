...
public class J_NecklaceOfDodgy extends ChargedItem {
    public J_NecklaceOfDodgy(
        ...
        super(ChargesImprovedConfig.dodgy_necklace, ItemID.DODGY_NECKLACE, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
