...
public class U_HuntsmansKit extends ChargedItemWithStorage {
    public U_HuntsmansKit(
        ...
        super(ChargesImprovedConfig.huntsmans_kit, ItemID.HUNTSMANS_KIT, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
