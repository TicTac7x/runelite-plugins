...
public class S_TomeOfFire extends ChargedItem {
    public S_TomeOfFire(
        ...
        super(ChargesImprovedConfig.tome_of_fire, ItemID.TOME_OF_FIRE, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
