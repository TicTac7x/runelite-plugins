...
public class U_BoneCrusher extends ChargedItemWithStatus {
    public U_BoneCrusher(
        ...
        super(ChargesImprovedConfig.bonecrusher, ItemID.BONECRUSHER, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
