...
public class J_NecklaceOfPassage extends ChargedItem {
    public J_NecklaceOfPassage(
        ...
        super(ChargesImprovedConfig.necklace_of_passage, ItemID.NECKLACE_OF_PASSAGE1, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
