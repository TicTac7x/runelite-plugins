...
public class F_SnowyKnightMix extends ChargedItem {
    public F_SnowyKnightMix(
        ...
        super(ChargesImprovedConfig.snowy_knight_mix, ItemID.SNOWY_KNIGHT_MIX_1, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
