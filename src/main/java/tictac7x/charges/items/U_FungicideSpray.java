...
public class U_FungicideSpray extends ChargedItem {
    public U_FungicideSpray(
        ...
        super(ChargesImprovedConfig.fungicide_spray, ItemID.FUNGICIDE_SPRAY_0, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
