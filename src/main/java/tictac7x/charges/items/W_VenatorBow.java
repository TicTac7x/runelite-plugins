...
public class W_VenatorBow extends ChargedItem {
    public W_VenatorBow(
        ...
        super(ChargesImprovedConfig.venator_bow, ItemID.VENATOR_BOW, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
