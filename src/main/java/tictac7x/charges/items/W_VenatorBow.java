...
public class W_VenatorBow extends ChargedItem {
    public W_VenatorBow(
        ...
        super(TicTac7xChargesImprovedConfig.venator_bow, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
