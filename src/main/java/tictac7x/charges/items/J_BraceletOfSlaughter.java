...
public class J_BraceletOfSlaughter extends ChargedItem {
    public J_BraceletOfSlaughter(
        ...
        super(ChargesImprovedConfig.bracelet_of_slaughter, ItemID.BRACELET_OF_SLAUGHTER, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
