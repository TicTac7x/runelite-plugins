...
public class J_RingOfCelestial extends ChargedItem {
    public J_RingOfCelestial(
        ...
        super(ChargesImprovedConfig.celestial_ring, ItemID.CELESTIAL_RING, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
