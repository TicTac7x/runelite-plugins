...
public class S_CrystalShield extends ChargedItem {
    public S_CrystalShield(
        ...
        super(ChargesImprovedConfig.crystal_shield, ItemID.CRYSTAL_SHIELD, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
