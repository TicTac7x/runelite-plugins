...
public class H_KandarinHeadgear extends ChargedItem {
    public H_KandarinHeadgear(
        ...
        super(ChargesImprovedConfig.kandarin_headgear, ItemID.KANDARIN_HEADGEAR_3, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
