...
public class U_TeleportCrystal extends ChargedItem {
    public U_TeleportCrystal(
        ...
        super(ChargesImprovedConfig.teleport_crystal, ItemID.TELEPORT_CRYSTAL, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
