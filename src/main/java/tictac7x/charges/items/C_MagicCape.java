...
public class C_MagicCape extends ChargedItem {
    public C_MagicCape(
        ...
        super(ChargesImprovedConfig.magic_cape, ItemID.MAGIC_CAPE, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
