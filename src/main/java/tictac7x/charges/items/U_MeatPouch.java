...
public class U_MeatPouch extends ChargedItemWithStorage {
    public U_MeatPouch(
        ...
        super(ChargesImprovedConfig.meat_pouch, ItemID.SMALL_MEAT_POUCH, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
