...
public class W_IbansStaff extends ChargedItem {
    public W_IbansStaff(
        ...
        super(TicTac7xChargesImprovedConfig.ibans_staff, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
