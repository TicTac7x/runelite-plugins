...
public class W_IbansStaff extends ChargedItem {
    public W_IbansStaff(
        ...
        super(ChargesImprovedConfig.ibans_staff, ItemID.IBANS_STAFF, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
