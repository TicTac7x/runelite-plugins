...
public class U_OgreBellows extends ChargedItem {
    public U_OgreBellows(
        ...
        super(ChargesImprovedConfig.ogre_bellows, ItemID.OGRE_BELLOWS, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
