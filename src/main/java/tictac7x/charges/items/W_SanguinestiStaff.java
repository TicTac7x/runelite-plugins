...
public class W_SanguinestiStaff extends ChargedItem {
    public W_SanguinestiStaff(
        ...
        super(ChargesImprovedConfig.sanguinesti_staff, ItemID.SANGUINESTI_STAFF, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
