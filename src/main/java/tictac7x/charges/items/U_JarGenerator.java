...
public class U_JarGenerator extends ChargedItem {
    public U_JarGenerator(
        ...
        super(ChargesImprovedConfig.jar_generator, ItemID.JAR_GENERATOR, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
