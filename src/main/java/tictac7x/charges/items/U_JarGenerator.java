...
public class U_JarGenerator extends ChargedItem {
    public U_JarGenerator(
        ...
        super(TicTac7xChargesImprovedConfig.jar_generator, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
