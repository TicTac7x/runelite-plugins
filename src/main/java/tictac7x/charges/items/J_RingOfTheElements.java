...
public class J_RingOfTheElements extends ChargedItem {
    public J_RingOfTheElements(
        ...
        super(TicTac7xChargesImprovedConfig.ring_of_the_elements, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
