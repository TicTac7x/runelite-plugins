...
public class J_DigsitePendant extends ChargedItem {
    public J_DigsitePendant(
        ...
        super(ChargesImprovedConfig.digsite_pendant, ItemID.DIGSITE_PENDANT_1, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
