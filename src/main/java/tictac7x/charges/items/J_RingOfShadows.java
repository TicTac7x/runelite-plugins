...
public class J_RingOfShadows extends ChargedItem {
    public J_RingOfShadows(
        ...
        super(ChargesImprovedConfig.ring_of_shadows, ItemID.RING_OF_SHADOWS, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
