...
public class W_TridentOfTheSeas extends ChargedItem {
    public W_TridentOfTheSeas(
        ...
        super(ChargesImprovedConfig.trident_of_the_seas, ItemID.TRIDENT_OF_THE_SEAS, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
