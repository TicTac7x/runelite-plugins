...
public class U_QuetzalWhistle extends ChargedItem {
    public U_QuetzalWhistle(
        ...
        super(TicTac7xChargesImprovedConfig.quetzal_whistle, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
