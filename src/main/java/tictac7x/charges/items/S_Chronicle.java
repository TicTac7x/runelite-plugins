...
public class S_Chronicle extends ChargedItem {
    public S_Chronicle(
        ...
        super(ChargesImprovedConfig.chronicle, ItemID.CHRONICLE, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
