...
public class S_Chronicle extends ChargedItem {
    public S_Chronicle(
        ...
        super(TicTac7xChargesImprovedConfig.chronicle, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
