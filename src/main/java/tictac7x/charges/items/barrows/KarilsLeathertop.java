...
public class KarilsLeathertop extends ChargedItem {
    public KarilsLeathertop(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.KARILS_LEATHERTOP, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
