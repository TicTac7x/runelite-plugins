...
public class VeracsPlateskirt extends ChargedItem {
    public VeracsPlateskirt(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.VERACS_PLATESKIRT, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
