...
public class AhrimsHood extends ChargedItem {
    public AhrimsHood(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.AHRIMS_HOOD, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
