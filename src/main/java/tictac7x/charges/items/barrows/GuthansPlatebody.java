...
public class GuthansPlatebody extends ChargedItem {
    public GuthansPlatebody(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.GUTHANS_PLATEBODY, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
