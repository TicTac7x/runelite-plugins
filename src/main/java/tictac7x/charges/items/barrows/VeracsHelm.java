...
public class VeracsHelm extends ChargedItem {
    public VeracsHelm(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.VERACS_HELM, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
