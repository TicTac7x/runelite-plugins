...
public class AhrimsRobetop extends ChargedItem {
    public AhrimsRobetop(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.AHRIMS_ROBETOP, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
