...
public class VeracsFlail extends ChargedItem {
    public VeracsFlail(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.VERACS_FLAIL, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
