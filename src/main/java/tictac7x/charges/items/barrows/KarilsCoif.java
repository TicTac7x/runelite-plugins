...
public class KarilsCoif extends ChargedItem {
    public KarilsCoif(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.KARILS_COIF, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
