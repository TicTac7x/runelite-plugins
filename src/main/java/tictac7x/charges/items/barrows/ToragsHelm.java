...
public class ToragsHelm extends ChargedItem {
    public ToragsHelm(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.TORAGS_HELM, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
