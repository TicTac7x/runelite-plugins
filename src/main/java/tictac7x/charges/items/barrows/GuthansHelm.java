...
public class GuthansHelm extends ChargedItem {
    public GuthansHelm(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.GUTHANS_HELM, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
