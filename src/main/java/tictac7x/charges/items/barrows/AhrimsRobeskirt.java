...
public class AhrimsRobeskirt extends ChargedItem {
    public AhrimsRobeskirt(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.AHRIMS_ROBESKIRT, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
