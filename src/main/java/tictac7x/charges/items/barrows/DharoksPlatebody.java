...
public class DharoksPlatebody extends ChargedItem {
    public DharoksPlatebody(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.DHAROKS_PLATEBODY, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
