...
public class GuthansChainskirt extends ChargedItem {
    public GuthansChainskirt(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.GUTHANS_CHAINSKIRT, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
