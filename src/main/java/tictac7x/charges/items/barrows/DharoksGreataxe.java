...
public class DharoksGreataxe extends ChargedItem {
    public DharoksGreataxe(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.DHAROKS_GREATAXE, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
