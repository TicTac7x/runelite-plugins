...
public class DharoksPlatelegs extends ChargedItem {
    public DharoksPlatelegs(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.DHAROKS_PLATELEGS, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
