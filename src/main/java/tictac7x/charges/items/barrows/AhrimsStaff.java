...
public class AhrimsStaff extends ChargedItem {
    public AhrimsStaff(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.AHRIMS_STAFF, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
