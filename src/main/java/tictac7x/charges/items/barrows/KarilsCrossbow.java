...
public class KarilsCrossbow extends ChargedItem {
    public KarilsCrossbow(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.KARILS_CROSSBOW, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
