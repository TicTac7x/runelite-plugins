...
public class KarilsLeatherskirt extends ChargedItem {
    public KarilsLeatherskirt(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.KARILS_LEATHERSKIRT, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
