...
public class ToragsPlatebody extends ChargedItem {
    public ToragsPlatebody(
        ...
        super(ChargesImprovedConfig.barrows_gear, ItemID.TORAGS_PLATEBODY, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
