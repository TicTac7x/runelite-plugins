...
public class U_AshSanctifier extends ChargedItemWithStatus {
    public U_AshSanctifier(
        ...
        super(ChargesImprovedConfig.ash_sanctifier, ItemID.ASH_SANCTIFIER, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
