...
public class J_RingOfPursuit extends ChargedItem {
    public J_RingOfPursuit(
        ...
        super(ChargesImprovedConfig.ring_of_pursuit, ItemID.RING_OF_PURSUIT, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
