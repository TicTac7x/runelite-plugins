...
public class A_CrystalHelm extends ChargedItem {
    public A_CrystalHelm(
        ...
        super(ChargesImprovedConfig.crystal_helm, ItemID.CRYSTAL_HELM, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
