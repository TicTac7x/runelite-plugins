...
public class A_CrystalHelm extends ChargedItem {
    public A_CrystalHelm(
        ...
        super(TicTac7xChargesImprovedConfig.crystal_helm, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
