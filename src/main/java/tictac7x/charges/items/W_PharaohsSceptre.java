...
public class W_PharaohsSceptre extends ChargedItem {
    public W_PharaohsSceptre(
        ...
        super(ChargesImprovedConfig.pharaohs_sceptre, ItemID.PHARAOHS_SCEPTRE, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
