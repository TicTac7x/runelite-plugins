...
public class W_Arclight extends ChargedItem {
    public W_Arclight(
        ...
        super(TicTac7xChargesImprovedConfig.arclight, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
