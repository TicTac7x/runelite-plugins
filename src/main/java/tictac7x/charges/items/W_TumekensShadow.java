...
public class W_TumekensShadow extends ChargedItem {
    public W_TumekensShadow(
        ...
        super(ChargesImprovedConfig.tumekens_shadow, ItemID.TUMEKENS_SHADOW, client, clientThread, configManager, itemManager, infoBoxManager, chatMessageManager, notifier, config, store, gson);
